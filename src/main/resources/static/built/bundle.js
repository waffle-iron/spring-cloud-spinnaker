...
/***/ function(module, exports, __webpack_require__) {
	...
	var follow = __webpack_require__(/*! ./follow */ 203);
	...
	var App = (function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function findModules() {
				...
				follow(client, root, ['modules']).done(function (response) {
					_this.setState({ modules: response.entity._embedded.appStatusList });
			...
			value: function render() {
				var modules = this.state.modules.map(function (module) {
					return React.createElement(Module, { details: module });
				});
	...
	var Module = (function (_React$Component2) {
		...
		_createClass(Module, [{
			...
			value: function render() {
				...
				var bits = Object.getOwnPropertyNames(this.props.details).map(function (name) {
					if (name !== '_links') {
						return React.createElement(
							'div',
							null,
							_this2.props.details[name]
						);
					}
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var errorCode = __webpack_require__(/*! rest/interceptor/errorCode */ 202);
